  ...
  return (
    <div className="py-16">
      <div className="container">
        {/*reusable component! */}
        <SectionHeader
          gradientTitle="Testimonials"
          mainTitle="What Our Clients Say"
          description="See what our satisfied clients have to say about our work"
        />
              ...
              <Fragment key={idx}>
                {testimonials.map((testimonial) => (
                  <Card
                    ...
                    className="max-w-xs p-6 md:p-8 hover:-rotate-3 transition duration-300"
                  >
                    <div className="flex gap-4 items-center">
                      <div className="size-14 bg-gray-700 inline-flex rounded-full items-center justify-center ">
                        <Image
                          className="max-h-full flex-shrink-0"
